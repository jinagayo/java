 ...
 *  public    : 접근 허용
 *  
 *  클래스의 객체 생성 막는법  => 생성자를 private로 한다.
 */
class Modifier1{
	private int v1 = 100;
			int v2 = 200;    //default
...
class Modifier3 extends Modifier2 {
	void mothod2() {
		System.out.println("ex8_modifier3 클래스의 method");
...
public class ModifierEx1 {
	...
	public static void main(String[] args) {
		...
		m1.method();
		System.out.println("ModifierEx1 클래스의 main 메소드에서 호출");
//		System.out.println("m1.v1="+ m1.v1);    //v1 접근제한자가 private 이므로 접근 불가
		...
		System.out.println("ModifierEx2 클래스의 main 메소드에서 호출");
//		System.out.println("m2.v1="+ m2.v1);    //v2 접근제한자가 private 이므로 접근 불가
