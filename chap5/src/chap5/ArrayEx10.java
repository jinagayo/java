...
public class ArrayEx10 {
	...
	public static void main(String[] args) {
		int[] arr1 = {10,20,30};
		// arr1 배열보다 하나 더 큰 배열을 생성하여 arr1의 배열값을 저장하고 합계를 마지막 요서에 저장하기
		...
		// System.arraycopy() 함수 이용
		int[] arr3 = new int[10];
		/*
		 * arraycopy(원본배열, 원본배열의 시작 인덱스 값, 복사본 배열, 복사배열의 시작 인덱스값, 요소의 갯수)
		 * arr2 : 10 20 30 60
		...
		// Arrays.copyOf() 함수 사용 방식
		// Arrays.copyOf(원본배열, 갯수)
		int[] arr4 = Arrays.copyOf(arr3, 5);
		for(int a : arr4)
			System.out.print(a+",");
		
		int[]arr5 = arr4;  // 얕은 복사. 두 개의 참조변수가 한개의 객체 참조
