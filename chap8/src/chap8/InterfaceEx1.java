 ...
 * 인터페이스 예제
 * 인터페이스
 * 1. 인터페이스의 멤버는 상수, 추상메소드, default메소드, static 메소드만 가능
 * 2. 인터페이스의 멤버의 접근제어자는 public. 생략해도 public임
 *    상수 : [public static final] 자료형 상수명
 *    추상메소드 : [public abstract] 리턴타입 메소드명(매개변수목록);
 *    default 메소드 : [public] 구현부 가능한 메소드.  인스턴스메소드
 *    static 메소드 : [public] 구현부 가능한 메소드.   클래스메소드
 * 3. 객체화 불가 => 구현클래스의 객체화를 통해서 객체화 가능
 * 4. 클래스와 인터페이스는 구현(implements)로 표현함.  다중구현 가능
 * 5. 인터페이스 간의 상속(extends)로 표현함.    다중 상속이 가능함
 */
